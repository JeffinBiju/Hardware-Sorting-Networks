...
VL_MODULE(Vpicorv32_wrapper_picorv32_wrapper) {
  ...
  public:
    ...
    static void _combo__TOP__picorv32_wrapper__7(Vpicorv32_wrapper__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    static void _initial__TOP__picorv32_wrapper__3(Vpicorv32_wrapper__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _sequent__TOP__picorv32_wrapper__2(Vpicorv32_wrapper__Syms* __restrict vlSymsp);
    static void _sequent__TOP__picorv32_wrapper__4(Vpicorv32_wrapper__Syms* __restrict vlSymsp);
    static void _sequent__TOP__picorv32_wrapper__6(Vpicorv32_wrapper__Syms* __restrict vlSymsp);
    static void _settle__TOP__picorv32_wrapper__1(Vpicorv32_wrapper__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__picorv32_wrapper__5(Vpicorv32_wrapper__Syms* __restrict vlSymsp) VL_ATTR_COLD;
